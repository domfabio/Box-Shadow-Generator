...
rulesArea.addEventListener("click", () => {
  ...
  navigator.clipboard.writeText(rules).then(() => {
    ...
    copyInstructions.style.fontWeight = "bold"; 

    setTimeout(() => {
      copyInstructions.innerText = "Clique no quadro acima para copiar as regras!";
      copyInstructions.style.fontWeight = "normal"; 
    }, 1200);
  });
});
...
// Cria o toggle switch para o modo escuro/claro
const toggleSwitch = document.createElement("div");
toggleSwitch.id = "toggle-dark-mode";
toggleSwitch.classList.add("toggle-switch");
document.body.prepend(toggleSwitch);
